...
export function PracticeProgress({ total, cycle, snapshot, complete, enabled, guide }: {
  total: number; cycle: number; snapshot: EngineSnapshot; complete: boolean; enabled: boolean; guide: string
}) {
  ...
  const label = complete ? `已完成 ${total} / ${total} 小节` : started ? `第 ${current} / ${total} 小节` : `准备开始 · 共 ${total} 小节`
